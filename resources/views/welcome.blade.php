...
<!-- Mirrored from keenitsolutions.com/products/html/educavo/index2.html by HTTrack Website Copier/3.x [XR&CO'2014], Wed, 07 Apr 2021 19:19:11 GMT -->
<head>
        <!-- meta tag -->
        <meta charset="utf-8">
        ...
        <div id="loader" class="loader">
            <div class="loader-container">
                <div class='loader-icon'>
                    <img src="{{ asset('front/assets//images/pre-logo.png')}}') }}" alt="">
                </div>
            </div>
        </div>
            ...
            <header id="rs-header" class="rs-header">
                            ...
                            <div class="col-lg-8 text-right">
                                <div class="rs-menu-area">
                                    <div class="main-menu">
                                      ...
                                      <nav class="rs-menu">
                                         <ul class="nav-menu">
                                            <li class="rs-mega-menu mega-rs menu-item-has-children current-menu-item"> <a href="index-2.html">Home</a>
                                                <ul class="mega-menu"> 
                ...
                <nav class="right_menu_togle hidden-md">
                    ...
                    <div class="canvas-logo">
                        <a href="index-2.html"><img src="{{ asset('front/assets//images/logo-dark.png')}}" alt="logo"></a>
                    </div>
                        ...
                        <div class="col-lg-8 pr-50 md-pr-15">
                            <div class="about-part">
                                ...
                                <div class="sign-part wow fadeInUp" data-wow-delay="600ms" data-wow-duration="2000ms">
                                    <div class="img-part">
                                        <img src="{{ asset('front/assets//images/about/ceo.png')}}" alt="CEO Image">
                                    </div>
                                    <div class="author-part">
                                        <span class="sign mb-10"><img src="{{ asset('front/assets//images/about/sign.png')}}" alt="Sign"></span>
                    ...
                    <div class="row">
                        <div class="col-lg-4 col-md-6 mb-30 wow fadeInUp" data-wow-delay="300ms" data-wow-duration="2000ms">
                            <a class="categories-item" href="#">
                                <div class="icon-part">
                                    <img src="{{ asset('front/assets//images/categories/icons/1.png')}}" alt="">
                                </div>
                        ...
                        <div class="col-lg-4 col-md-6 mb-30 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="2000ms">
                            <a class="categories-item" href="#">
                                <div class="icon-part">
                                    <img src="{{ asset('front/assets//images/categories/icons/2.png')}}" alt="">
                                </div>
                                <div class="content-part">
                        ...
                        <div class="col-lg-4 col-md-6 mb-30 wow fadeInUp" data-wow-delay="500ms" data-wow-duration="2000ms">
                            <a class="categories-item" href="#">
                                <div class="icon-part">
                                    <img src="{{ asset('front/assets//images/categories/icons/3.png')}}" alt="">
                                </div>
                                <div class="content-part">
                        ...
                        <div class="col-lg-4 col-md-6 mb-30 wow fadeInUp" data-wow-delay="300ms" data-wow-duration="2000ms">
                            <a class="categories-item" href="#">
                                <div class="icon-part">
                                    <img src="{{ asset('front/assets//images/categories/icons/4.png')}}" alt="">
                                </div>
                                <div class="content-part">
                        ...
                        <div class="col-lg-4 col-md-6 mb-30 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="2000ms">
                            <a class="categories-item" href="#">
                                <div class="icon-part">
                                    <img src="{{ asset('front/assets//images/categories/icons/5.png')}}" alt="">
                                </div>
                                <div class="content-part">
                        ...
                        <div class="col-lg-4 col-md-6 mb-30 wow fadeInUp" data-wow-delay="500ms" data-wow-duration="2000ms">
                            <a class="categories-item" href="#">
                                <div class="icon-part">
                                    <img src="{{ asset('front/assets//images/categories/icons/6.png')}}" alt="">
                                </div>
                                <div class="content-part">
                        ...
                        <div class="col-lg-4 col-md-6 mb-30 wow fadeInUp" data-wow-delay="500ms" data-wow-duration="2000ms">
                            <a class="categories-item" href="#">
                                <div class="icon-part">
                                    <img src="{{ asset('front/assets//images/categories/icons/7.png')}}" alt="">
                                </div>
                                <div class="content-part">
                        ...
                        <div class="col-lg-4 col-md-6 mb-30 wow fadeInUp" data-wow-delay="500ms" data-wow-duration="2000ms">
                            <a class="categories-item" href="#">
                                <div class="icon-part">
                                    <img src="{{ asset('front/assets//images/categories/icons/8.png')}}" alt="">
                                </div>
                                <div class="content-part">
                        ...
                        <div class="col-lg-4 col-md-6 mb-30 wow fadeInUp" data-wow-delay="500ms" data-wow-duration="2000ms">
                            <a class="categories-item" href="#">
                                <div class="icon-part">
                                    <img src="{{ asset('front/assets//images/categories/icons/9.png')}}" alt="">
                                </div>
                                <div class="content-part">
                ...
                <div class="container">
                    ...
                    <div class="row">
                        ...
                        <div class="col-lg-4 col-md-6  mb-30 wow fadeInUp" data-wow-delay="300ms" data-wow-duration="2000ms">
                            <div class="courses-item">
                                <div class="img-part">
                                    <img src="{{ asset('front/assets//images/courses/4.jpg')}}" alt="">
                                </div>
                                <div class="content-part">
                                    <ul class="meta-part">
                                        <li><span class="price">$55.00</span></li>
                        ...
                        <div class="col-lg-4 col-md-6  mb-30 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="2000ms">
                            <div class="courses-item">
                                <div class="img-part">
                                    <img src="{{ asset('front/assets//images/courses/5.jpg')}}" alt="">
                                </div>
                                <div class="content-part">
                                    <ul class="meta-part">
                                        <li><span class="price">$55.00</span></li>
                        ...
                        <div class="col-lg-4 col-md-6  mb-30 wow fadeInUp" data-wow-delay="500ms" data-wow-duration="2000ms">
                            <div class="courses-item">
                                <div class="img-part">
                                    <img src="{{ asset('front/assets//images/courses/6.jpg')}}" alt="">
                                </div>
                                <div class="content-part">
                                    <ul class="meta-part">
                                        <li><span class="price">$55.00</span></li>
            ...
            <div id="rs-team" class="rs-team style1 gray-bg pt-94 pb-100 md-pt-64 md-pb-70">
                <div class="container">
                    ...
                    <div class="rs-carousel owl-carousel nav-style2" data-loop="true" data-items="3" data-margin="30" data-autoplay="true" data-hoverpause="true" data-autoplay-timeout="5000" data-smart-speed="800" data-dots="false" data-nav="true" data-nav-speed="false" data-center-mode="false" data-mobile-device="1" data-mobile-device-nav="false" data-mobile-device-dots="false" data-ipad-device="2" data-ipad-device-nav="false" data-ipad-device-dots="false" data-ipad-device2="2" data-ipad-device-nav2="false" data-ipad-device-dots2="false" data-md-device="3" data-md-device-nav="true" data-md-device-dots="false">
                        ...
                        <div class="team-item">
                            <img src="{{ asset('front/assets//images/team/3.jpg')}}" alt="">
                            <div class="content-part">
                    ...
                    <div class="rs-carousel owl-carousel" 
                        ...
                        <div class="testi-item">
                            <div class="author-desc">                                
                                <div class="desc"><img class="quote" src="{{ asset('front/assets//images/testimonial/style5/quote2.png')}}" alt="">Professional, responsive, and able to keep up with ever-changing demand and tight deadlines: That’s how I would describe Jeramy and his team at The Lorem Ipsum Company. When it comes to content marketing, you’ll definitely get the 5-star treatment from the Lorem Ipsum Company.</div>
                                <div class="author-img">
                                    <img src="{{ asset('front/assets//images/testimonial/style5/1.png')}}" alt="">
                                </div>
                            </div>
                            <div class="author-part">
                        ...
                        <div class="testi-item">
                            <div class="author-desc">
                                <div class="desc"><img class="quote" src="{{ asset('front/assets//images/testimonial/style5/quote2.png')}}" alt="">I was skeptical of SEO and content marketing at first, but the Lorem Ipsum Company not only proved itself financially speaking, but the response I have received from customers is incredible. The work is top-notch and I consistently outrank all my competitors on Google.</div>
                                <div class="author-img">
                                    <img src="{{ asset('front/assets//images/testimonial/style5/2.png')}}" alt="">
                                </div>
                            </div>
                            <div class="author-part">
                        ...
                        <div class="testi-item">
                            <div class="author-desc">
                                <div class="desc"><img class="quote" src="{{ asset('front/assets//images/testimonial/style5/quote2.png')}}" alt="">After being forced to move twice within five years, our customers had a hard time finding us and our sales plummeted. The Lorem Ipsum Co. not only revitalized our brand, but saved our nearly 100-year-old family business from the brink of ruin by optimizing our website for SEO
                                 Our Clients.</div>
                                <div class="author-img">
                                    <img src="{{ asset('front/assets//images/testimonial/style5/3.png')}}" alt="">
                                </div>
                            </div>
                            <div class="author-part">
                        ...
                        <div class="row">
                            <div class="col-lg-7 col-md-12 pr-75 md-pr-15 md-mb-50">
                                ...
                                <div class="row align-items-center no-gutter white-bg blog-item mb-30 wow fadeInUp" data-wow-delay="400ms" data-wow-duration="2000ms">
                                    <div class="col-md-6">
                                        <div class="image-part">
                                            <a href="#"><img src="{{ asset('front/assets//images/blog/2.jpg')}}" alt=""></a>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="blog-content">
                                ...
                                <div class="row align-items-center no-gutter white-bg blog-item wow fadeInUp" data-wow-delay="500ms" data-wow-duration="2000ms">
                                    <div class="col-md-6">
                                        <div class="image-part">
                                            <a href="#"><img src="{{ asset('front/assets//images/blog/3.jpg')}}" alt=""></a>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="blog-content">
