            ...
            <section class="content">
                ...
                <div class="col-md-12">
                    ...
                    <div class="card card-primary">
                        ...
                        <!-- /.card-header -->
                        <!-- form start -->
                        <form action="{{ route('videos.store', ['cour_id' => $cour_id]) }}" method="post" enctype="multipart/form-data">
                            @csrf
                            <div class="card-body" id="inputs">
                                ...
                                <div class="form-group" id="document">
                                    ...
                                    <input type="text" class="form-control" name="link" value="{{ old('link') }}" id="link" placeholder="Saisir document de module">
                                    @error('link')
                                        <p class="text-danger">{{ $message }}</p>
                                    @enderror
                                </div>
