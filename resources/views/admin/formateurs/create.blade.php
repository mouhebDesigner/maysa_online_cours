                                ...
                                <div class="row">
                                    <div class="col-md-8 offset-md-2">
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="numtel" value="{{ old('numtel') }}" id="numtel" placeholder="Saisir numéro de téléphone de formateur">
                                                @error('numtel')
                                                    <p class="text-danger">{{ $message }}</p>
                                                @enderror
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="text" class="form-control" name="specialite" value="{{ old('specialite') }}" id="specialite" placeholder="Saisir spécialité de formateur">
                                                @error('specialite')
                                                    <p class="text-danger">{{ $message }}</p>
                                                @enderror
                                            </div>
